...
SmartPhone Compatible web template, free WebDesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- //chart -->
    <!-- Metis Menu -->
    <script src="{{asset('backend/js/metisMenu.min')}}"></script>
...
<body class="cbp-spmenu-push">
    ...
    <div class="main-content">
            ...
            <aside class="sidebar-left">
                <nav class="navbar navbar-inverse">
                    <div class="navbar-header">
                        ...
                        <h1>
                            <a class="navbar-brand" href="{{url('/')}}"><span class="fa fa-area-chart"></span> Web
                                phim
                            </a>
                        </h1>
                    </div>
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="treeview {{($segment=='genre')? 'active' : ''}}">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li>
                                        <a href="{{route('genre.index')}}"><i class="fa fa-angle-right"></i> Danh sách
                                            thể loại</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="treeview {{($segment=='country')? 'active' : ''}}">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li>
                                        <a href="{{route('country.index')}}"><i class="fa fa-angle-right"></i> Danh sách
                                            quốc gia</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="treeview {{($segment=='movie')? 'active' : ''}}">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li>
                                        <a href="{{route('movie.index')}}"><i class="fa fa-angle-right"></i> Danh sách
                                            phim</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="treeview {{($segment=='episode')? 'active' : ''}}">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li>
                                        <a href="{{route('episode.index')}}"><i class="fa fa-angle-right"></i> Danh sách
                                            tập</a>
                                    </li>
                                </ul>
                            </li>
        ...
        <div class="footer">
            <p>
            &emsp;  &emsp;  &emsp;  &emsp;  &emsp;   Đồ án tốt nghiệp &ensp;  &ensp; Sinh viên : Phạm Bình Minh   &ensp;  &ensp;  63IT3  &ensp; &ensp; MSSV : 142463
            </p>
        </div>
        <!--//footer-->
    </div>
