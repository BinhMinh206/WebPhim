...
<head>
    ...
    <style>
        #header .site-title {
            background: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQ1a4UaTgrW9n36xizoHB6fMrQbDLRwiA6fpw5jUC6p9bGW0oOFCTL32FXNHV3_uxN-Kg&usqp=CAU) no-repeat top left;
        ...
        <div class="container">
            <div class="row" id="headwrap">
                <div class="col-md-3 col-sm-6 slogan">
                    <p class="site-title"><img src="{{asset('uploads/movie/kisspng-product-design-brand-logo.jpg')}}" class="lazy post-thumb" alt="CHỊ MƯỜI BA: BA NGÀY SINH TỬ" title="CHỊ MƯỜI BA: BA NGÀY SINH TỬ" /></p>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="form-group form-timkiem">
                                <form action="{{route('tim-kiem')}}" method="GET">
                                    <input id="timkiem" type="text" name="search" class="form-control" placeholder="Tìm kiếm..." autocomplete="off" required style="display: block;">
                                    <i class="animate-spin hl-spin4 hidden"></i>
                                    <button class="btn btn-primary" style="display: none;">Tìm kiếm</button>
                                </form>
                            </div>
                ...
                <div class="collapse navbar-collapse" id="halim">
                    <div class="menu-menu_1-container">
                        <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                            ...
                            @endforeach
                            <li class="current-menu-item"><a title="Tất cả" href="{{route('all')}}">Tất cả phim</a></li>
                            ...
                            <li class="mega dropdown">
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    @for($year=2000;$year<=2022;$year++) <li><a title="{{$year}}" href="{{url('nam/'.$year)}}">{{$year}}
                                        </a>
                            </li>
                    ...
                    $.getJSON('/json_file/movies.json', function(data) {
                        $.each(data, function(key, value) {
                            if (value.title.search(expression) != -1 || value.description.search(expression) != -1) {
                                $('#result').css('display', 'inherit');
                                $('#result').append('<li style ="cursor : pointer " class = " list-group-item link-class "><img src ="/uploads/movie/' + value.image + '" height = "100" width = "50" class =""/><span> </span>' + value.title + '<br> <span class ="text-muted "> </span></li>');
                            }
                        });
                    });
                } else {
